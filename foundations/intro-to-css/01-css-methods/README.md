...
### Self Check
yes - Did you use all three methods of adding CSS to an HTML file?
yes Did you properly link the external CSS file in the HTML file?
yes Does the `div` element have CSS added via the external method?
yes Does the `p` element have CSS added via the internal method?
yes Does the `button` element have CSS added via the inline method?
